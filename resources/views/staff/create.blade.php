...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group row">
                <label for="example-url-input" class="col-sm-2 col-form-label">Branch</label>
                <div class="col-sm-10">
                    <input class="form-control" type="url" value="" placeholder="Please select your branch" id="example-url-input">
                </div>
            </div>
            {{-- <div class="form-group row">
